...
# Download the SDK
- Head to `https://github.com/firebase/firebase-ios-sdk`
- Download the latest release
- Extract and copy contents of `Firebase` into `libs/ios/firebase` (you can copy only the library folders required, for instance `FirebaseCrashlytics`)
- Sync gradle
